...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> nomeDuplicadoException (NomeDuplicadoException ex) {
        String mensagem = "Erro de integridade de dados: O nome do produto já existe ou há outra violação de restrição.";
